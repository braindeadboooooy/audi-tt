 ...
 * \date   May 2020
 * 
 *         Заголовочный файл с функциями для работы с информацией о СИЗ и перегрузка операторов ввода/вывода
 * 
 * 
 * 
 *********************************************************************/
...
/** 
 * Функция заполнения информации о СИЗ
 * Название СИЗ
 * Срок использования
 */
