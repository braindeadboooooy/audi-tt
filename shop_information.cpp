 ...
 * \date   May 2020
 * 
 *         Заголовочный файл с функциями для работы с информацией о цехах и перегрузка операторов ввода/вывода
 * 
 * 
 *********************************************************************/
...
/**
 * Конструктор информации о цехе
 * Название цеха
 * Конструктор информации о цехе
 * Номер сотрудника, размер массива сотрудников
 * Номер СИЗ, размер массива СИЗ
...
/**
 * Функция заполнения названия цеха
 */
