 ...
 * \date   May 2020
 *         
 *         Исходный файл с конструктором и фукнцией заполнения информации о сотруднике
 *           
 *         
 *********************************************************************/
...
/**
 * Конструктор информации о сотруднике
...
/**
 * Функция заполнения формы информации о сотруднике 
 * Имя Фамилия Отчество
 */
