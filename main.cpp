...
int main(int argc, char *argv[])
{
    ...
    for (;;)
    {
         ...
         * перевыделение памяти в случае увеличения числа сотрудников в цеху чем Getmas_size_sotrudnik
         ...
         * перевыделение памяти в случае увеличения числа СИЗ в цеху чем Getmas_size_ciz
         ...
         * Выделение памяти под массив цехов
        ...
        break;
        /**
         * Вывод информации о цехах с СИЗами
         */
        case 6:
        {
            for (int i = 0; i < count_shop; ++i)
        ...
        /**
         * Расчет количества сизов необходимых для:
